...
- Live production verification caught Gemini's rejection of the numeric enum generated by `z.literal(1)` in response schemas; the workflow version now uses an equivalent bounded integer contract.
