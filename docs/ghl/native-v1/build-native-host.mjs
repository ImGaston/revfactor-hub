...
const files=['native-property-adapter.mjs','native-account-adapter.mjs','native-host.mjs'];
...
for(const kind of ['property','account']){
 ...
 const markup=guide+'<section id="rf-native-status" aria-live="polite">Loading your saved onboarding details…</section>';
