...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex size-full flex-col overflow-hidden rounded-4xl bg-transparent p-1 text-popover-foreground",
        className
      )}
      {...props}
    />
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn("my-1.5 h-px bg-foreground/8", className)}
      {...props}
    />
  )
}
