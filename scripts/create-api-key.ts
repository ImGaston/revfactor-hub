...
console.log(`\n  ${plaintext}\n`)
console.log("Store it now — it is not recoverable. Send it over a secure channel;")
console.log("it must live server-side in the consumer's stack, never in a browser.\n")
